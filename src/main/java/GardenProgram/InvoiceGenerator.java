...
public class InvoiceGenerator {
    ...
    public static String generate(Map<String, String> invoiceData) {
        ...
        //  In GardenGUI, has a HashMap with invoice data, using the keys and values described above.
        //  this method is called to generate the invoice String.
        ...
        // When a placeholder, eg. ${LEAVES} is found in the template, it will be replaces
